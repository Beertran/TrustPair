...
def search_weather_by_woeid(woeid: int, days_from_today: int = 1):
    ...
    """
    url_format = 'https://www.metaweather.com/api/location/{}'
    ...
    if days_from_today <= 5:
        ...
        click.echo('Forecasts cannot be made reliably more than 5 days ahead.')
...
def search(city: str, limit: int):
    ...
    """
    url_format = 'https://www.metaweather.com/api/location/search/?query={}'
...
def coord(latitude: float, longitude: float, limit: int, days_from_today: int):
    ...
    """
    url_format = 'https://www.metaweather.com/api/location/search/?lattlong={}'
